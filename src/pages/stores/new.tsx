            ...
            <div className='sm:col-span-3'>
              ...
              <div className='mt-2'>
                <input
                  ...
                  className='block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 outline-none px-2 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6'
                />
